...
over a bounded interval.  Still, this theorem alone does not give a simple
way to construct a Cauchy sequence representing a root.  Thus, 
these three aspects
...
\end{itemize}
This work is part of a more ambitious plan, aiming at providing a procedure
...
of correctness.  Some of these connections will require large size proofs.
For instance, we anticipate a sizeable development to describe the procedure
to reduce the multiplicity of roots (dividing by the greatest common divisor
between the polynomial and its derivative) and to describe the termination
of procedure based on successive dichotomy.
\section{Conclusion}
