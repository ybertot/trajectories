...
\((b_i)_{0\leq i \leq n}\), such that \(p(x) = \sum_{i=0}^n P_b(n,l,r,i)(x)\).  The coefficients
...
These points can
be moved about the vertical line \(x=l + i\frac{r-l}{n}\).  When \(b_i\) is
...
Here the {\em intermediate value theorem} does not hold
...
a polynomial on a given number is done recursively following Horner's scheme,
...
the reversed polynomial is \(Q(x) = -x^2 + \frac{3}{2} + 1\) and after
