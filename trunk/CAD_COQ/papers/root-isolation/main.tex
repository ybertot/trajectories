...
\section{The definition of Bernstein coefficients}
\label{sec:bernsteindef}
Given a pair of numbers \(l\) and \(r\), a natural number \(n\), and
a polynomial of degree smaller than or equal to \(n\),
\(p = \sum_{i=0}^n a_i X^i\), the Bernstein
coefficients are the numbers \(b_i\), for \(i\in \{0, \ldots, n\}\) defined
by the following equality{\sf WARNING: ATTENTION: VORSICHT: Assia, sais-tu
si cette formule est correcte?}
