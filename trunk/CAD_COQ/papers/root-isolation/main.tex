...
\end{lstlisting}
as available in the \ssr{} library. This injection allows to combine
...
generic injection of the semi-ring of natural numbers in the
ring. This is so widely used that a new notation is defined: \L+n%:R+
