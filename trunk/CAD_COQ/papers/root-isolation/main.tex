...
sequence (and its modulus of convergence).  The limit of this
Cauchy sequence in the real numbers
...
a list \C{s} that has a non-zero last element, or zero, and in this case formed
...
represented as functions of type \C{nat -> Qcb}. The correctness lemmas
