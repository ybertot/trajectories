...
On the other hand, the \ssr{} libraries still lack of the automated
proof producing decision procedures available in the standard \Coq{}
system, like ring normalization or linear arithmetic decision. The
\ssr{} structures are indeed still not connected.


%  This tactic might furthermore be enhanced to be able to deal
