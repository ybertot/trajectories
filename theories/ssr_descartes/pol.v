...
From mathcomp Require Import binomial  bigop ssralg poly ssrnum ssrint rat polyrcf.
...
Proof.
move => /andP [xp xy].
case: n; first by rewrite !expr0 lexx ler01.
have yp: y \is Num.nneg by apply: le_trans xy.
